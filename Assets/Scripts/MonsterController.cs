...
public class MonsterController : Stats
{
    ...
    // если добавить цикл в апдейт ничего сверхъестественного не произойдёт, ну будет этот цикл выполняться в каждом апдейте и всё,
    // так и так если цикл будет бесконечный, то в апдейте он или нет - игра повиснет
